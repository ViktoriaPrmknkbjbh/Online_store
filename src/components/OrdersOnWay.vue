...
<div class="grid">
    ...
    <div class="grid-card-2">
        <div class="grid-card">
                <div class="nastroki1">
                    <RouterLink class="routLink1" :to="{ name: 'OrdersOnWay' }">
                        Заказы в пути
                    </RouterLink>
                </div>
                <div class="nastroki1">
                    <RouterLink class="routLink1" :to="{ name: 'Returns' }">
                        Возвраты
                    </RouterLink>
                </div>
                <div class="nastroki2">
                    <RouterLink class="routLink1" :to="{ name: 'CompletedOrders' }">
                        Завершённые заказы
                    </RouterLink>
                </div>
            </div>
            ...
            <div class="notcova">
                ...
                <h2>Нет текущих заказов
                </h2>
                <p>
                    Перейдите в
                    <RouterLink class="rout-link" :to="{ name: 'Basket' }">корзину</RouterLink>,
                    чтобы оформить заказ.
                </p>
            </div>
    </div>
    <div class="grid-card-3"> <div class="nastroki">
...
.nastroki1{
    ...
    height: 40px;
    width: 200px;
    box-shadow: 2px 1px 1px var(--grin);
    border-radius: 5px;
margin: 20px;
...
.grid {
    display: grid;
    grid-template-columns: 0.5fr 5.5fr 2fr;
}
.grid-card-3{
    margin-top: 50px;
}
